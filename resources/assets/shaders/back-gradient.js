...
void main() {
    vec3 u_color1 = vec3(138, 73, 149);
    vec3 u_color2 = vec3(37, 82, 197);
    vec3 u_color3 = vec3(68, 159, 171);
    ...
    vec2 a = 1.1 * u_resolution.xy; // First gradient point.
    vec2 b = 1.0 * u_resolution.xy; // second gradient point.
